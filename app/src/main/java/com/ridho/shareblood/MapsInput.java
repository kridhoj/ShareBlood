...
public class MapsInput extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.OnConnectionFailedListener {
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful() && task.getResult() != null){
                            ...
                            Geocoder geocoder = new Geocoder(MapsInput.this);
                            ...
                            Toast.makeText(MapsInput.this,"Cant Find Location",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void init(){
        ...
        mPilih.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MapsInput.this,addressP,Toast.LENGTH_LONG).show();
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(MapsInput.this);
    }
    ...
    private void sendToStart() {
        Intent startintent = new Intent(MapsInput.this,SplashScreen.class);
