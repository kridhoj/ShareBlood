...
public class MapsInputBlood extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.OnConnectionFailedListener{
    @Override
        ...
        if (mLocationPermissionsGranted) {
            ...
            mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                ...
                public void onMapClick(LatLng latLng) {
                    ...
                    Geocoder geocoder =
                            new Geocoder(MapsInputBlood.this);
                    List<Address> list;
                    try {
                    ...
                    MarkerOptions options = new MarkerOptions()
                            ...
                            .position(new LatLng(latLng.latitude,
                                    latLng.longitude))
                            .snippet("Longtitude :"+ mLat.longitude)
                            .snippet("Latitude : "+ mLat.latitude);
    ...
    private void getDeviceLocation(){
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MapsInputBlood.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful() || task.getResult() != null){
                            ...
                            Geocoder geocoder = new Geocoder(MapsInputBlood.this);
                           /* List<Address> list = new ArrayList<>();
                            ...
                            if (list.size() > 0){
                                ...
                                moveCamera(new LatLng(currentLocation.getLatitude(),currentLocation.getLongitude()),DEFAULT_ZOOM,"Location");

                            } else{
                            Toast.makeText(MapsInputBlood.this,"Cant Find Location",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void init(){
        ...
        mPilih.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MapsInputBlood.this,addressP,Toast.LENGTH_LONG).show();
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(MapsInputBlood.this);
    }
    ...
    private void sendToStart() {
        Intent startintent = new Intent(MapsInputBlood.this,SplashScreen.class);
